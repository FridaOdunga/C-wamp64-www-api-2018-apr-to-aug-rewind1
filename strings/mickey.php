...
";
$wce_array = explode("," ,strtoupper($wambua_corrupted_employees));
//print_r($word);
...
$wce_arrays = explode(",",strtoupper($wambua_corrupted_employees));
$wce_array3 = array_splice(array_unique($wce_arrays), 8, 254);
